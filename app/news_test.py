...
class ArticleTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        Set up method that will run before every test
        '''
        self.new_article = Article("Ukraine's Zelensky asks citizens to resist and Europe to do more", "Ukraine's president tells Europe it has the \"strength to stop this aggression\" and calls for action.", "http://www.bbc.co.uk/news/world-europe-60527346", "https://ichef.bbci.co.uk/news/1024/branded_news/E1CA/production/_123420875_hi074132197.jpg", "2022-02-25T17:22:23.06428Z")
    ...
    def test_init(self):
        ...
        self.assertEqual(self.new_article.url,"http://www.bbc.co.uk/news/world-europe-60527346")
